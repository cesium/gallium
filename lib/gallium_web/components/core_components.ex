defmodule GalliumWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GalliumWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GalliumWeb.Gettext, "errors", msg, opts)
    end
  end
