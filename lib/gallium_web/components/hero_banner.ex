defmodule GalliumWeb.HeroBanner do
  ...
  def hero_banner(assigns) do
    ~H"""
    <div class="bg-olive py-8 ">
      <div class="relative w-full font-serif h-auto bg-[url(/frames/frame2.svg)] bg-contain bg-no-repeat bg-center">
        <div class=" flex flex-col items-center justify-center text-center py-3">
          <div class="flex flex-col gap-3 p-12">
            ...
            <h1 class="text-olive-50 font-amarante leading-tight tracking-wide text-5xl m-0">
              JANTAR<br />DE GALA
            </h1>
